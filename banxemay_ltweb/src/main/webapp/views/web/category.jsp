    ...
    <div class="row margin-bottom-40">
      ...
      <div class="sidebar col-md-3 col-sm-5">
        <ul class="list-group margin-bottom-25 sidebar-menu">
            ...
            <ul class="dropdown-menu" style="display:block;">
              ...
              <li class="list-group-item dropdown clearfix  <c:if test="${cid == 0}">active</c:if> ">
      ...
      <div class="col-md-9 col-sm-7">
        ...
        <div class="row product-list">
          ...
          <c:forEach items="${productCate}" var="pc">

          <!-- PRODUCT ITEM START -->
          <div id="1" class="col-md-4 col-sm-6 col-xs-12"  >
            <div class="product-item" >
              <div class="pi-img-wrapper">
                <img  src="${pc.image}" width="200" height="120 " alt="${pc.name}">
                <div>
                  <a href="${pc.image}" class="btn btn-default fancybox-button">Zoom</a>
                  <a href="/home/product?pid=${pc.id}" class="btn btn-default fancybox-fast-view">View</a>
                </div>
              </div>
              <h3><a href="/home/product?pid=${pc.id}">${pc.name}</a></h3>
              <div class="pi-price">${pc.price}</div>
