var EcommerceOrdersView = function () {
    ...
    //             "ajax": {
    //                 "url": "../templates/demo/ecommerce_order_invoices.php", // ajax source
    //             },
    //             "order": [
    //                 [1, "asc"]
    ...
    //             "pageLength": 10, // default record count per page
    //             "ajax": {
    //                 "url": "../templates/demo/ecommerce_order_credit_memos.php", // ajax source
    //             },
    ...
    //             "pageLength": 10, // default record count per page
    //             "ajax": {
    //                 "url": "../templates/demo/ecommerce_order_shipment.php", // ajax source
    //             },
    //             "columnDefs": [{ // define columns sorting options(by default all columns are sortable extept the first checkbox column)
    //                 'orderable': true,
    //                 'targets': [0]
    ...
    //             "pageLength": 10, // default record count per page
    //             "ajax": {
    //                 "url": "../templates/demo/ecommerce_order_history.php", // ajax source
    //             },
    //             "columnDefs": [{ // define columns sorting options(by default all columns are sortable extept the first checkbox column)
    //                 'orderable': true,
    //                 'targets': [0]
